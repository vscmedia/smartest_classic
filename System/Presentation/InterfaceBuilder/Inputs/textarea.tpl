    <textarea name="{$_input_data.name}" style="{$_input_data.style}" placeholder="{$_input_data.placeholder}" id="{$_input_data.id}"{if $_input_data.class} class="{$_input_data.class}"{/if}{if $_input_data.data_format} data-format="{$_input_data.data_format}"{/if}{if $_input_data.limit} maxlength="{$_input_data.limit}"{/if}>{$_input_data.value.html_escape}</textarea>{if $_input_data.limit} <span id="{$_input_data.id}-charcount" class="length-warn {$_input_data.limit_warning_class}">{$_input_data.value.length}</span>/{$_input_data.limit}{/if}
