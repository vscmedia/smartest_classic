<div id="admin-menu">
  <ul>
    ...
    <li class="top-level{if $section == "settings" || $section == "dropdowns"} on{else} off{/if}" id="nav-settings"><a href="{$domain}smartest/settings"><span class="option-holder"><i class="flaticon solid slider-1"></i>{$_l10n_global_strings.main_nav.settings}</span></a></li>
    {else}
