<div id="admin-menu">
  <ul>
    ...
    <li class="top-level{if $section == "datamanager" || $section == "sets"} on{else} off{/if}" id="nav-items"><a href="{$domain}smartest/models"><span class="option-holder"><i class="fa fa-database"></i><span class="option-name">{$_l10n_global_strings.main_nav.items}</span></span></a></li>
