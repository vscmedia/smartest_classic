...
function smarty_function_page_group($params, $smartest_engine){
    ...
    if(isset($params['name'])){
        ...
        $group_name = SmartestStringHelper::toSlug($params['name']);
        
        $database = SmartestDatabase::getInstance('SMARTEST');
        $sql = "SELECT * FROM Sets WHERE set_name='".$page_name."' AND (set_site_id='".$site_id."' OR set_shared='1') AND set_type='SM_SET_PAGEGROUP_PERMANENT'";
