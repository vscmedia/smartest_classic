...
function smarty_function_email_input($params, &$smartest_engine){
    ...
    if(isset($params['name'])){
        ...
        $smartest_engine->assign('email_regex', SmartestStringHelper::EMAIL_ADDRESS);
        $smartest_engine->run(SM_ROOT_DIR.'System/Presentation/InterfaceBuilder/Inputs/email.tpl', array());
