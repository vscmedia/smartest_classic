<?sm:* Do not edit this file. To customise this markup, place your own template in either Sites/SITE_DIR/Presentation/Special/eu_cookie_warning.tpl (Site specific, checked first) or Presentation/Special/eu_cookie_warning.tpl (all sites). Feel free to copy everything below this line, or change to suit your needs. *:?>
