...
<div id="actions-area">
      ...
      {if $request_parameters.page_id && $request_parameters.from == 'preview'}
        <li class="permanent-action"><a href="#" onclick="window.location='{$domain}websitemanager/preview?page_id={$request_parameters.page_id}{if $request_parameters.item_id}&amp;item_id={$request_parameters.item_id}{/if}'"><img border="0" src="{$domain}Resources/Icons/tick.png"> Return page preview</a></li>
      {elseif $request_parameters.page_id && $request_parameters.from == 'fullPreview'}
        <li class="permanent-action"><a href="#" onclick="window.location='{$domain}website/renderEditableDraftPage?page_id={$request_parameters.page_id}{if $request_parameters.item_id}&amp;item_id={$request_parameters.item_id}{/if}&amp;hide_newwin_link=true'"><img border="0" src="{$domain}Resources/Icons/tick.png"> Return page preview</a></li>
      ...
      {/if}
      <li class="permanent-action"><a href="#" onclick="window.location='{$domain}{$section}/previewSet?set_id={$set.id}{if $request_parameters.page_id}&amp;page_id={$request_parameters.page_id}{/if}{if $request_parameters.item_id}&amp;item_id={$request_parameters.item_id}{/if}{if $request_parameters.from}&amp;from={$request_parameters.from}{/if}'"><img border="0" src="{$domain}Resources/Icons/folder_explore.png"> Browse set contents</a></li>
      <li class="permanent-action"><a href="#" onclick="window.location='{$domain}{$section}/deleteSetConfirm?set_id={$set.id}'"><img border="0" src="{$domain}Resources/Icons/cross.png"> Delete this set</a></li>
			<li class="permanent-action"><a href="#" onclick="window.location='{$domain}{$section}/editStaticSetOrder?set_id={$set.id}{if $request_parameters.page_id}&amp;page_id={$request_parameters.page_id}{/if}{if $request_parameters.item_id}&amp;item_id={$request_parameters.item_id}{/if}{if $request_parameters.from}&amp;from={$request_parameters.from}{/if}'"><img border="0" src="{$domain}Resources/Icons/arrow_switch.png"> Change the order of this set</a></li>
