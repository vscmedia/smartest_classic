...
{else}
  ...
  <h3>Authors of this page</h3>
    ...
    <div class="warning">Are people missing from this list? Users must now have the 'author_credit' {help id="users:tokens"}token{/help} to be credited as the author of a page.{if $provide_tokens_link} <a href="{$domain}smartest/users">Click here</a> to edit user tokens.{/if}</div>
