...
<div id="actions-area">
  <ul class="actions-list" id="non-specific-actions">
    ...
    <li class="permanent-action"><a href="{dud_link}" onclick="window.location='{$domain}{$section}/editAsset?assettype_code={$asset_type.id}&amp;asset_id={$asset.id}{if $request_parameters.from}&amp;from={$request_parameters.from}{/if}'"><img src="{$domain}Resources/Icons/pencil.png" alt=""/> Edit in rich-text editor</a></li>
    <li class="permanent-action"><a href="{dud_link}" onclick="window.location='{$domain}{$section}/editTextFragmentSource?assettype_code={$asset_type.id}&amp;asset_id={$asset.id}{if $request_parameters.from}&amp;from={$request_parameters.from}{/if}'"><img src="{$domain}Resources/Icons/page_edit.png" alt=""/> Edit file source</a></li>
  </ul>
</div>
