<ul class="tabset">
    ...
    {if $group.is_gallery}<li{if $method == "arrangeAssetGallery"} class="current"{/if}><a href="{$domain}{$section}/arrangeAssetGallery?group_id={$group.id}">{$_l10n_strings.groups.group_tabs.gallery_arrange}</a></li>{/if}
