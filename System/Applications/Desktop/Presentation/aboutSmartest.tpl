<div id="work-area">
  ...
  <div>
    <div style="float:left;width:106px;height:675px">
      <a href="http://smartestproject.org/?ref=about_screen" target="_blank"><img src="{$domain}Resources/System/Images/info_logo.png" alt="Smartest" style="width:106px;height:106px" /></a>
    </div>
      ...
      <p style="margin-top:15px">
          <p style="margin-top:20px"><span style="font-size:10px;color:#999">Smartest is produced, published and marketed by VSC Media International OÜ., a company registered in the Republic of Estonia with number 16514050. "Smartest" and the Smartest logo are trademarks of and © VSC Media International OÜ, 2022-{$now.Y}.</span></p>
          <a href="https://www.vscmedia.com/" target="_blank"><img id="about-modal-logo" src="{$domain}Resources/System/Images/vsc-media-2018-logo-colour.png" alt="More great software from VSC Media" /></a>
      </p>
