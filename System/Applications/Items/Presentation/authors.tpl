<div id="work-area">
  ...
  <h3>Authors of this {$item._model.name|lower}</h3>
    ...
    <div class="special-box">Are people missing from this list? Users must have the 'author_credit' {help id="users:tokens"}token{/help} to be credited as the author of an item.{if $provide_tokens_link} <a href="{$domain}smartest/users" class="button">Click here</a> to edit user tokens.{/if}</div>
